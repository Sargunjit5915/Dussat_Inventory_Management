...
const adminNavItems = [
  ...
  },
  {
    ...
    label: "Order Status",
    icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
  },
  {
    ...
    <aside className="sidebar">
      <div className="sidebar-header">
        <div className="sidebar-logo">
          <span className="logo-mark" style={{ background:"var(--danger)" }}>ADM</span>
      ...
      <div className="sidebar-footer">
        <div className="user-info">
          <div className="user-avatar" style={{ background:"var(--danger)", borderColor:"var(--danger-dim)", color:"var(--danger-fg)" }}>
            {user?.email?.[0]?.toUpperCase() ?? "A"}
          </div>
          <div className="user-details">
            <p className="user-email">{user?.email}</p>
            <span className="user-role-badge" style={{ color:"var(--danger-fg)", background:"var(--danger)" }}>Admin</span>
          </div>
        </div>
